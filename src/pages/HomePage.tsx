          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Deploy a high-performace file server in record time with our
                optimized, ready-to-use solution. Packed with modern
      ...
      <section className="py-16 bg-white w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div className="mt-10 lg:mt-0 border border-gray-300 p-4 rounded-2xl">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-gray-900 text-white">
      ...
      <footer className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <p className="text-sm">
              Copyright © 2025 NextFileManager. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
